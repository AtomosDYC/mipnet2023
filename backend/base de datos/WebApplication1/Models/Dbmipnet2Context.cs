...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-F2O1H1IJ; Initial Catalog=DBmipnet2; User Id=sa;password=.,sql!gent4; MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=False;Connection Timeout=3600");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Prf01Perfile>(entity =>
        {
            ...
            entity.HasIndex(e => e.Prf05Llave, "IX_PRF01_Perfiles_PRF05_llave");

            entity.HasIndex(e => e.Secu02Llave, "IX_PRF01_Perfiles_SECU02_llave");
            ...
            entity.HasMany(d => d.Prf03Llaves).WithMany(p => p.Prf01Llaves)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    l => l.HasOne<Prf01Perfile>().WithMany()
                    ...
                    j =>
                    {
                        ...
                        j.HasIndex(new[] { "Prf03Llave" }, "IX_PRF02_PlantillasUsuario_Prf03Llave");
                    });
        });
