...
public partial class DbMContext : DbContext
{
    ...
    public virtual DbSet<Prf04PlantillaPerfil> Prf04PlantillaPerfils { get; set; }
    ...
    public virtual DbSet<Secu02Usuario20170202> Secu02Usuario20170202s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=200.29.13.34;Initial Catalog=db_m;Persist Security Info=False;User ID=sa;Password=.,sql!gent4;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=False;Connection Timeout=300000;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Clbr01Llave).HasName("PK_CLBR01_TipoCalibracion");
        ...
        {
            entity.HasKey(e => e.Cnt04Llave).HasName("PK_CNT04_ContactoCliente_1");
        ...
        {
            entity.HasKey(e => e.Cnt12Llave).HasName("PK_CNT12_Empleados_1");
        ...
        {
            entity.HasKey(e => e.Cont02Llave).HasName("PK_CONT02_TipoContacto_1");
        ...
        modelBuilder.Entity<Secu02Usuario20170202>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("SECU02_Usuario20170202");
            ...
            entity.Property(e => e.Fechaeliminacion)
                ...
                .HasColumnName("FECHAELIMINACION");
            entity.Property(e => e.Secu02Activo).HasColumnName("SECU02_Activo");
            entity.Property(e => e.Secu02Bloqueado).HasColumnName("SECU02_Bloqueado");
            entity.Property(e => e.Secu02Clave)
                .HasMaxLength(200)
                .HasColumnName("SECU02_Clave");
            entity.Property(e => e.Secu02ComplementoClave)
            ...
            entity.Property(e => e.Secu02Respuesta)
                .HasMaxLength(600)
                .HasColumnName("SECU02_Respuesta");
            entity.Property(e => e.Secu02Usuario)
                .HasMaxLength(100)
                .HasColumnName("SECU02_Usuario");
            entity.Property(e => e.Secu04TipoEncriptacion).HasColumnName("SECU04_TipoEncriptacion");
        });
