...
export enum Types {
  ...
  DELETE_TIPOPERCOMUNICACION = '[DELETE] dELETE',
  DELETE_TIPOPERCOMUNICACION_SUCCESS = '[DELETE] tipopercomunicacion Success',
  DELETE_TIPOPERCOMUNICACION_ERROR = '[DELETE] tipopercomunicacion Error',
