...
import { MonitorEspeciesComponent } from './monitor-especies.component';
...
@NgModule({
  ...
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    StoreModule.forFeature('monitorespecie', reducers),
    EffectsModule.forFeature(effects),
    
  ]
})
export class MonitorEspeciesModule { }
