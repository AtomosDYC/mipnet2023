...
import { MonitorCelularesComponent } from './monitor-celulares.component';
...
@NgModule({
  ...
  imports: [
    ...
    ReactiveFormsModule,
    StoreModule.forFeature('monitorsincronizacion', reducers),
    EffectsModule.forFeature(effects),
  ]
})
export class MonitorCelularesModule { }
