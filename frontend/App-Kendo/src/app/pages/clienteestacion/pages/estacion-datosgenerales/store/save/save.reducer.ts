import { ClienteEstacionResponse, ClienteEstacionActivaSource, MenuEstacionResponse } from './save.models';
...
export interface ListState {
  ...
  menuestacion: MenuEstacionResponse[] | null;
...
export function reducer(state: ListState = initialState, action: fromActions.All | any) {
    switch(action.type){
      ...
      //getmenu
      case fromActions.Types.GET_CLIENTEESTACION_MENU: {
        return {...state, loading: true, error: null, menuestacion:null}
      }

      case fromActions.Types.GET_CLIENTEESTACION_MENU_SUCCESS: {
        return {...state, loading: false, menuestacion: action.menuestacion}
      }

      case fromActions.Types.GET_CLIENTEESTACION_MENU_ERROR: {
        return  {...state, loading: false, error: action.error, menuestacion:null}
      }
