...
import { ClienteestacionComunicacionComponent } from './clienteestacion-comunicacion.component';
...
@NgModule({
  declarations: [
    ClienteestacionComunicacionComponent
  ],
  exports: [
    ClienteestacionComunicacionComponent
  ],
  imports: [
    ...
    FormsModule,
    ReactiveFormsModule,
    StoreModule.forFeature('clienteestacioncomunicacion', reducers),
    EffectsModule.forFeature(effects),
  ]
})
export class ClienteestacionComunicacionModule { }
