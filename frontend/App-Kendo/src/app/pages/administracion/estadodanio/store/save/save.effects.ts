...
export class SaveEffects {
  ...
  getbyid: Observable<Action> = createEffect(() =>
    this.actions.pipe(
      ...
      switchMap((id: string) => {
        return this.httpClient.get<EstadoDanioResponse>(`${environment.url}api/estadosdanio/GetEstadosDanioById/${id}`)
        .pipe(
  ...
  Desactivate: Observable<Action> = createEffect(() =>
    this.actions.pipe(
      ...
      switchMap((estadosdanios: EstadoDanioResponse[]) => {
        return this.httpClient.post<EstadoDanioResponse[]>(`${environment.url}api/estadosdanio/disableestadosdanio/`, estadosdanios)
        .pipe(
  ...
  Activate: Observable<Action> = createEffect(() =>
    this.actions.pipe(
      ...
      switchMap((estadosdanios: EstadoDanioResponse[]) => {
        return this.httpClient.post<EstadoDanioResponse[]>(`${environment.url}api/estadosdanio/activateestadosdanio/`, estadosdanios)
        .pipe(
