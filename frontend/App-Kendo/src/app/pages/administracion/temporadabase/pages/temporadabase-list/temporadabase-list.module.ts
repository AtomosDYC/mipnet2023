...
import { TemporadabaseListRoutingModule } from './temporadabase-list-routing.module';
...
@NgModule({
  declarations: [
    TemporadabaseListComponent
  ],
  imports: [
    CommonModule,
    TemporadabaseListRoutingModule,
    ButtonModule,
    CardModule,
    GridModule,
    SharedModule,
...
export class TemporadabaseListModule { }
